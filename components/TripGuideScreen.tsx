  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="p-5 flex-row items-center justify-between">
        <View>
          <Text className="text-2xl font-medium text-gray-800">Hello, Vanessa</Text>
      ...
      <View className="px-5 mb-4">
        <Text className="text-xl font-semibold text-gray-800">Select your next trip</Text>
      </View>
        ...
        {["Asia", "Europe", "South America", "North America"].map((region, index) => (
          <TouchableOpacity
            ...
            className={`px-4 py-3 mr-3 rounded-full ${
              region === "South America" ? "bg-black" : "bg-white border border-gray-100"
            }`}
            style={{ 
          ...
          >
            <Text 
              className={`${region === "South America" ? "text-white" : "text-gray-700"} text-center`}
              style={{ fontSize: 15 }}
              numberOfLines={1}
            >
              {region}
        ...
        <View className="flex-row">
          ...
          <View className="w-72 mr-4">
            <View className="relative">
              <Image
                source={{ uri: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" }}
              ...
              <View className="absolute bottom-0 left-0 right-0 p-4">
                <Text className="text-white font-bold text-xl">Rio de Janeiro</Text>
          ...
          <View className="w-72 mr-4">
            <View className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <View className="p-3 border-b border-gray-100">
                <Text className="font-semibold text-gray-800">Rio de Janeiro</Text>
                <Text className="text-xs text-gray-500">Brazil</Text>
              </View>
              <Image
                source={{ uri: "https://images.unsplash.com/photo-1516306580123-e6e52b1b7b5f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" }}
                className="w-full h-32"
              />
              <View className="p-3">
                <Text className="text-gray-700 text-sm mb-2">
                  Discover the vibrant culture and stunning beaches of Rio de Janeiro.
                </Text>
                <View className="flex-row justify-between items-center">
                  <View className="flex-row items-center">
                    <FontAwesome name="star" size={12} color="gold" />
                    <Text className="text-gray-700 text-xs ml-1">5.0 (143)</Text>
                  </View>
          ...
          {/* Third Card - Review Card */}
          <View className="w-72">
            <View className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <View className="p-3 border-b border-gray-100 flex-row justify-between items-center">
                <View>
                  <Text className="font-semibold text-gray-800">User Reviews</Text>
                  <Text className="text-xs text-gray-500">Rio de Janeiro</Text>
                </View>
                <View className="flex-row items-center">
                  <FontAwesome name="star" size={12} color="gold" />
                  <Text className="text-gray-700 text-xs ml-1">5.0</Text>
                </View>
              </View>
              <View className="p-3">
                <View className="flex-row items-start mb-3">
                  ...
                  <View className="flex-1">
                    <Text className="font-semibold text-gray-800 text-sm">Sarah M.</Text>
                    <Text className="text-gray-700 text-xs">
                      Amazing experience! The beaches were beautiful and the people were so friendly.
                    </Text>
                  </View>
                </View>
                <View className="flex-row items-start">
                  ...
                  />
                  <View className="flex-1">
                    <Text className="font-semibold text-gray-800 text-sm">John D.</Text>
                    <Text className="text-gray-700 text-xs">
                      Incredible city with so much to see and do. Highly recommend!
                    </Text>
                  </View>
                </View>
              </View>
      ...
      <TouchableOpacity className="flex-row items-center justify-between px-5 mt-4">
